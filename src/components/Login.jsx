...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Email Address and Password Combination Invalid.");
      setPassword("");
    }
  };
  ...
  return (
    <>
      <div className="bg-black min-h-full flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          {error.length > 1 && (
            <div className="pt-2 pb-2 border rounded border-rose-300 bg-rose-300">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="remember-me"
                  className="ml-2 block text-sm text-teal-500"
                >
                  Remember me
                </label>
              </div>
